        ...
        <div class="col-md-5">
            ...
            <div class="d-flex justify-content-start">
                <form method="POST" action="{{ route('mypage.destroy') }}">
                    ...
                    <div class="btn dashboard-delete-link" data-bs-toggle="modal" data-bs-target="#delete-user-confirm-modal">退会</div>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <p class="text-center">一度退会するとデータはすべて削除されて復旧できません。</p>
